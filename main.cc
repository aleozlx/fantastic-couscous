// g++ main.cpp -I /usr/include/opencv4 -L /usr/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_ximgproc -lopencv_imgcodecs -lopencv_videoio -lopencv_video
